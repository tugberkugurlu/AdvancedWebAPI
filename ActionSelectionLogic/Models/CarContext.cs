...
namespace ActionSelectionLogic.Models {
    ...
    public class CarsContext {
        ...
        private readonly static ConcurrentDictionary<int, Car> _carsDictionary = new ConcurrentDictionary<int, Car>(new HashSet<KeyValuePair<int, Car>> { 
            ...
            new KeyValuePair<int, Car>(3, new Car { Id = 3, Make = "Make3", Model = "Model1", Year = 2012, Price = 67437.0F }),
            new KeyValuePair<int, Car>(4, new Car { Id = 4, Make = "Make1", Model = "Model3", Year = 2007, Price = 78984.2F }),
            new KeyValuePair<int, Car>(5, new Car { Id = 5, Make = "Make2", Model = "Model1", Year = 2011, Price = 56200.89F }),
            new KeyValuePair<int, Car>(6, new Car { Id = 6, Make = "Make3", Model = "Model4", Year = 1997, Price = 46003.2F }),
            new KeyValuePair<int, Car>(7, new Car { Id = 7, Make = "Make1", Model = "Model5", Year = 2001, Price = 78355.92F }),
            new KeyValuePair<int, Car>(8, new Car { Id = 8, Make = "Make2", Model = "Model1", Year = 2011, Price = 1823223.23F })
        });
